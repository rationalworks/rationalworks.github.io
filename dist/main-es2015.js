...
NavigationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavigationComponent, selectors: [["app-navigation"]], decls: 7, vars: 4, consts: [[1, "sidebar", "hidden-sm-down"], ["id", "side-menu", 1, "nav", "in"], [3, "routerLink", "routerLinkActive"], [1, "fa", "fa-hom"], [1, "hide-menu"]], template: function NavigationComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
